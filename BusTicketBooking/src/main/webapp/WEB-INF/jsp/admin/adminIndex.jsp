...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<c:url value="/images/admin/univerceBus1.jpg"/>" class="d-block w-100" alt="bannerBus1">
        </div>
        <div class="carousel-item">
            <img src="<c:url value="/images/admin/univerceBus2.jpg"/>" class="d-block w-100" alt="bannerBus2">
        </div>
        <div class="carousel-item">
            <img src="<c:url value="/images/admin/univerceBus3.jpg"/>" class="d-block w-100" alt="bannerBus3">
        </div>
    </div>
...
<div class="row mt-3">
    ...
    <div class="col-4">
        <a href="<c:url value="/admin/typeemployee"/>" class="text-decoration-none my-card-hover">
            <div class="card shadow p-3 mb-5 bg-body rounded justify-content-center" style="width: 18rem; height: 18rem;">
